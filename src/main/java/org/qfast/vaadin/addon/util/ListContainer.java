...
public class ListContainer<T> extends AbstractContainer implements
    ...
    private static final long serialVersionUID = -1491700813316484161L;
    ...
    public static Class getNestedPropertyType(DynaClass bean, String name)
        ...
        return bean.getDynaProperty(name).getType();
    }
    ...
    public int indexOfId(Object itemId) {
        return getBackingList().indexOf((T) itemId);
    }
    ...
    public T nextItemId(Object itemId) {
        int i = getBackingList().indexOf((T) itemId) + 1;
        ...
        public int compare(T o1, T o2) {
            for (int i = 0; i < propertyId.length; i++) {
                ...
                Comparator<T> currentComparator
                        = new BeanComparator<>(currentProperty, getUnderlyingComparator(currentProperty));
    ...
    public class DynaBeanItem<E> implements Item {

        private static final long serialVersionUID = -6548573460704220359L;
        ...
        private class DynaProperty implements Property {
            ...
            private static final long serialVersionUID = -5256089161348562119L;
